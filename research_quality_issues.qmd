...
-   CoCoPop (Factor, disease, symptom or health **Co**ndition of interest, the epidemiological indicator used to measure its frequency (prevalence, incidence), the **Pop**ulation or groups at risk as well as the **Co**ntext/location and time period where relevant)

**For better understanding, follow the links below**

[How to Ask the Right Question and Find the Right Answer: Clinical Research for Transplant Nephrologists](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9128998/)

[Formulation of Research Question -- Stepwise Approach](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6322175/)

[NIE-ICMR. BASIC COURSE IN BIOMEDICAL RESEARCH](https://nie.gov.in/icmr_sph/Online-courses.html)
:::
