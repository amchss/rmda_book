...
a.  For Windows users, choose "Install R for the first time" (next to the base subdirectory) and then "Download R 4.4.1 for Windows"

b.  For macOS users, select the appropriate version for your operating system (e.g. the latest release is version 4.4.1, will look something like R-4.4.1-arm64.pkg), then choose to Save or Open
...
3.  Click on the correct installer version, save, open once downloaded, agree to license and install like you would any other software. The version should be at least RStudio 2023.06.2 "Mountain Hydrangea", 2023.
